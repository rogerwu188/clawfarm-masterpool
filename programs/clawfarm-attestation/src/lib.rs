...
use instructions::challenge::{
    ...
    __client_accounts_resolve_challenge, __client_accounts_timeout_reject_challenge,
};
...
pub use instructions::{
    ...
    ResolveChallenge, RevokeProviderSigner, SetPause, SubmitReceipt, TimeoutRejectChallenge,
...
pub mod clawfarm_attestation {
    ...
    pub fn revoke_provider_signer(
        ...
        instructions::admin::revoke_provider_signer(ctx, signer, provider_wallet)
    }
    ...
    pub fn timeout_reject_challenge(ctx: Context<TimeoutRejectChallenge>) -> Result<()> {
        instructions::challenge::timeout_reject_challenge(ctx)
    }
