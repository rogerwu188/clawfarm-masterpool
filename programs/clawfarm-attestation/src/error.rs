...
pub enum ErrorCode {
    ...
    ProviderMismatch,
    #[msg("Receipt payer/provider identities do not match the supplied accounts")]
    ...
    InvalidWindow,
    #[msg("Challenge resolution timeout is still open")]
    ChallengeResolutionTimeoutOpen,
    #[msg("Authority pubkey is invalid")]
    InvalidAuthority,
    #[msg("Pause authority pubkey is invalid")]
    InvalidPauseAuthority,
    #[msg("Challenge resolver pubkey is invalid")]
    InvalidChallengeResolver,
    #[msg("Masterpool program is invalid")]
    InvalidMasterpoolProgram,
    #[msg("Signer pubkey is invalid")]
    InvalidSigner,
    #[msg("Provider wallet pubkey is invalid")]
    InvalidProviderWallet,
